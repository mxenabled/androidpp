...
// that generated it.
    class BlobCache : public mindroid::Ref, public Flattenable {
public:
...
private:
    ...
    class Blob : public mindroid::Ref {
    public:
    ...
    public:
        CacheEntry();
        CacheEntry(const mindroid::sp<Blob>& key, const mindroid::sp<Blob>& value);
        CacheEntry(const CacheEntry& ce);

        bool operator<(const CacheEntry& rhs) const;
        const CacheEntry& operator=(const CacheEntry&);

        mindroid::sp<Blob> getKey() const;
        mindroid::sp<Blob> getValue() const;

        void setValue(const mindroid::sp<Blob>& value);

    private:

        // mKey is the key that identifies the cache entry.
        mindroid::sp<Blob> mKey;

        // mValue is the cached data associated with the key.
        mindroid::sp<Blob> mValue;
    };
