...
protected:
     ...
     */
    virtual void composeLayer(mindroid::sp<Snapshot> current, mindroid::sp<Snapshot> previous);
     ...
     */
    mindroid::sp<Snapshot> getSnapshot() {
        return mSnapshot;
    }
...
private:
     ...
     */
    bool createLayer(mindroid::sp<Snapshot> snapshot, float left, float top, float right, float bottom,
     ...
     * @param previousFbo The name of the current framebuffer
     */
    bool createFboLayer(Layer* layer, Rect& bounds, mindroid::sp<Snapshot> snapshot,
            GLuint previousFbo);
...
//        glBindTexture(GL_TEXTURE_EXTERNAL_OES, texture);
    ...
    int mSaveCount;
    // Base state
    mindroid::sp<Snapshot> mFirstSnapshot;
    // Current state
    mindroid::sp<Snapshot> mSnapshot;
