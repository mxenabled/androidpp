...
platform/android/jni/Java_org_cocos2dx_lib_Cocos2dxGLSurfaceView.cpp \
...
LOCAL_STATIC_LIBRARIES += mindroid_static

# define the macro to compile through support/zip_support/ioapi.c
LOCAL_CFLAGS := -DUSE_FILE32API -DANDROID -DBUILD_FOR_ANDROID
LOCAL_EXPORT_CFLAGS := -DUSE_FILE32API -DANDROID -DBUILD_FOR_ANDROID
