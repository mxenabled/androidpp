...
// we find one.
bool TextLayout::needsLayout(const UChar* text, int len, int bidiFlags) {
...
void TextLayout::handleText(SkPaint *paint, const UChar* text, size_t len,
...
void TextLayout::getTextRunAdvances(SkPaint* paint, const UChar* chars, int start,
...
void TextLayout::getTextRunAdvancesICU(SkPaint* paint, const UChar* chars, int start,
                                    int count, int contextCount, int dirFlags,
                                    float* resultAdvances, float& resultTotalAdvance) {
...
void TextLayout::getTextPath(SkPaint *paint, const UChar *text, size_t len,
                             int bidiFlags, float x, float y, SkPath *path) {
    handleText(paint, text, len, bidiFlags, x, y, path);
}


void TextLayout::drawTextOnPath(SkPaint* paint, const UChar* text, size_t len,
...
void TextLayout::computeAdvancesWithICU(SkPaint* paint, const UChar* chars,
    ...
    SkAutoSTMalloc<CHAR_BUFFER_SIZE, UChar> tempBuffer(contextCount);
    UChar* buffer = tempBuffer.get();
