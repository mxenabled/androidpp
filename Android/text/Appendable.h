...
#ifndef Androidpp_Appendable_h
#define Androidpp_Appendable_h
...
public:
     ...
     */
    virtual Appendable &append(shared_ptr<CharSequence> csq) = 0;
     ...
     *          If an I/O error occurs
     */
    virtual Appendable &append(shared_ptr<CharSequence> csq, int start, int end) = 0;
