...
#ifndef cocos2dx_Adapter_h
#define cocos2dx_Adapter_h
...
public:
     ...
     */
    virtual shared_ptr<Object> getItem(int position) = 0;
     ...
     */
    virtual shared_ptr<View> getView(int position, shared_ptr<View> convertView, ViewGroup *parent) = 0;
     ...
     */
    static const int IGNORE_ITEM_VIEW_TYPE = -1;
     ...
     */
    virtual int getItemViewType(int position) = 0;
     ...
     */
    virtual int getViewTypeCount() = 0;
    
    static const int NO_SELECTION = INT_MIN;
